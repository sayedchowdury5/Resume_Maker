...
if(isset($_POST['post_btn'])){
	...
	$sql = "INSERT INTO forum (forum_name, title, forum_text) VALUES ('$forum_name', '$title', '$forum_text')";
 	mysqli_query($db,$sql);
	echo "<script>alert('Your forum has been posted')</script>";
 }?>
...
fo
	...
	<body>
		<header>
			...
			<a href="forum_dark.php">Switch to Dark Mode</a></h1>
			<nav>
				<ul>
